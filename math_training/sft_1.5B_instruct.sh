...
accumula=$((32 / batch_size / gpu_count))
...
for dataset in "${datasets[@]}"; do
    output_dir=/home/nfs02/laizj/experiment/uncertainty_analysis/math_training/model/$model_name-${dataset}-${num_train_epochs}-${learning_rate}
