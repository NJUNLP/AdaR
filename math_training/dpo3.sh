...
datasets=("qwen7b_instruct-generate_dpo_pairs-qwen7b_instruct-generate_cot_with_code-qwen72b_instruct-generate_template_and_code-orca_10k_train-disturbed_1.0-code") 
learning_rate=1e-6
num_train_epochs=1
